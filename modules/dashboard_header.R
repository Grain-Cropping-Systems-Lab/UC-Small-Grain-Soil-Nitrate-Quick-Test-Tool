dashboard_header_ui <- function(id, label = "header") {
	ns <- NS(id)
	dashboardHeader(title = "The Nitrogen Fertilizer Management Tool for California Wheat (Beta)", titleWidth = 700,
	...
	moduleServer(
		...
		function(input, output, session){
			observeEvent(input$open_info_modal, {
				showModal(
					modalDialog(title = "About The Nitrogen Fertilizer Management Tool for California Wheat (Beta)",
											HTML("The Nitrogen Fertilizer Management Tool for California Wheat (Beta) was first published in April 2020. It was last updated on: 1/8/2021."),
											br(), br(),
											...
											br(), br(),
											HTML("To cite this page, please use: Nelsen, T., Rosa, G., & Lundy, M. (2020, April 23). <i>The Nitrogen Fertilizer Management Tool for California Wheat (Beta).</i> Retrieved from http://smallgrain-n-management.plantsciences.ucdavis.edu/"),
											br(), br(),
